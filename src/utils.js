...
export const labName = 'Cognitive and Affective Neuroscience Lab'; // name of lab running HIT experiment 
...
export const studyTasks = 'giving continuous ratings while watching videos'; // brief summary of HIT task for consent form
export const experiment = 'spacetop'; // name of experiment (should match collection name in firebase)
